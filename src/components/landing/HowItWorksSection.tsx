...
const STEP_ICONS = [ListChecks, FileText, Video, CheckCircle];

export const HowItWorksSection = () => {
  const { settings } = useCtaMessages();

  const title = settings.howitworks_title || "Veja como funciona a emissão";
    ...
    <section className="bg-deep text-deep-foreground py-16 md:py-24">
      <div className="mx-auto max-w-5xl px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-sm md:text-base text-deep-foreground/70">{subtitle}</p>
        </div>
